...
SAVE_DIR = "/raid/dtle/NTIRE26-DeepfakeDetection/misc/deroded_xxxx/"
if os.path.exists(SAVE_DIR):
    shutil.rmtree(SAVE_DIR) 
os.makedirs(SAVE_DIR, exist_ok=True)

# how many batches/images to dump (prevent huge IO)
MAX_SAVE_BATCHES = 10          # only save first N batches of the epoch
...
class Trainer(object):
    ...
    def train_epoch(self, epoch, train_data_loader, test_data_loaders=None):
        ...
        train_dir_name = "combined_train_set"
        self.save_data_dict('train', train_data_loader.dataset.data_dict, train_dir_name)
        ...
        for iteration, data_dict in tqdm(enumerate(train_data_loader), total=total_iter, dynamic_ncols=True):
            # # ================= QUICK DEBUG =================
            # if iteration <= 4 and self.config['local_rank'] == 0:
            #     self.logger.info("\n" + "="*40)
            ...
            if is_sync_step and ((iteration + 1) % 32 == 0 or iteration == total_iter-1) and self.config['local_rank']==0:
                ...
                for i, param_group in enumerate(self.optimizer.param_groups):
                    ...
                    writer = self.get_writer('train', train_dir_name, f'lr_group_{i}')
                ...
                for k, v in train_recorder_loss.items():
                    ...
                    if v_avg != None:
                        ...
                        writer = self.get_writer('train', train_dir_name, k)
